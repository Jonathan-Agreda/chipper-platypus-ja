    ...
    return(
      <div className='flex flex-col w-80'>
        ...
        <div className='text-center'>
          <a className='font-light text-xs uderline underline-offset-4' href='/'>Forgot my password</a>
        </div>
        <button
      ...
      <form ref={form} className='flex flex-col gap-4 w-80'>
        <div className='flex flex-col gap-1'>
          ...
          <input 
            ...
            placeholder:text-sm placeholder:text-base/60 focus:outline-none py-2 px-4'
          />
        </div>
        <div className='flex flex-col gap-1'>
